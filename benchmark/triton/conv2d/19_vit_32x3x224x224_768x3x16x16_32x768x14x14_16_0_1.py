...
CASE_PATH = 'benchmark/choreo/conv2d/19_vit_32x3x224x224_768x3x16x16_32x768x14x14_16_0_1.co'
CASE_NAME = '19_vit_32x3x224x224_768x3x16x16_32x768x14x14_16_0_1'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['32x3x224x224', '768x3x16x16']
OUTPUT_TOKEN = '32x768x14x14'
BASE_NOTES = 'stride=16; padding=0; dilation=1'
...
HOST_EXTRAS = {'stride': 16, 'padding': 0, 'dilation': 1}
