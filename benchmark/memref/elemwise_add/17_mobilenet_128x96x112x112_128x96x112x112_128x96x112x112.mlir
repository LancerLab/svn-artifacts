module @f_17_mobilenet_128x96x112x112_128x96x112x112_128x96x112x112 {
  func.func @f_17_mobilenet_128x96x112x112_128x96x112x112_128x96x112x112(%in0: memref<128x96x112x112xf32>, %in1: memref<128x96x112x112xf32>) -> memref<128x96x112x112xf32> {
    ...
    %in1_d0 = memref.dim %in1, %c0 : memref<128x96x112x112xf32>
    %in1_d1 = memref.dim %in1, %c1 : memref<128x96x112x112xf32>
    %in1_d2 = memref.dim %in1, %c2 : memref<128x96x112x112xf32>
    %in1_d3 = memref.dim %in1, %c3 : memref<128x96x112x112xf32>
      ...
      scf.for %ae1 = %c0 to %in0_d1 step %c1 {
        scf.for %ae2 = %c0 to %in0_d2 step %c1 {
          scf.for %ae3 = %c0 to %in0_d3 step %c1 {
            %v0 = memref.load %in0[%ae0, %ae1, %ae2, %ae3] : memref<128x96x112x112xf32>
            %v1 = memref.load %in1[%ae0, %ae1, %ae2, %ae3] : memref<128x96x112x112xf32>
            %out_val = arith.addf %v0, %v1 : f32
            memref.store %out_val, %out[%ae0, %ae1, %ae2, %ae3] : memref<128x96x112x112xf32>
          }
        }
      }
    }
