...
module {
  func.func @f_12_dynamic_64xTx256_256x128_64xTx128_mismatch(%a: tensor<64x?x256xf32>, %b: tensor<255x128xf32>) -> tensor<64x?x128xf32> {
    ...
    } ins(%a, %b : tensor<64x?x256xf32>, tensor<255x128xf32>)
