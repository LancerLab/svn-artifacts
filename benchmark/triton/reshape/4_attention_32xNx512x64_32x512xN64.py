...
CASE_PATH = 'benchmark/choreo/reshape/4_attention_32xNx512x64_32x512xN64.co'
CASE_NAME = '4_attention_32xNx512x64_32x512xN64'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'N': 8, 'N64': 8}
INPUT_TOKENS = ['32xNx512x64']
OUTPUT_TOKEN = '32x512xN64'
BASE_NOTES = 'contract-invalid 4_attention_32xNx512x64_32x512xN64: reshape must preserve element count'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--N64", type=int, default=8)
