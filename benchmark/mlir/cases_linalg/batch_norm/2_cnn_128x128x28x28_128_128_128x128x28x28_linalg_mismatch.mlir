module {
  func.func @f_2_cnn_128x128x28x28_128_128_128x128x28x28_mismatch(%input: tensor<128x128x28x28xf32>, %gamma: tensor<127xf32>, %beta: tensor<128xf32>) -> tensor<128x128x28x28xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<128x128x28x28xf32>, tensor<127xf32>, tensor<128xf32>) outs(%init : tensor<128x128x28x28xf32>) {
