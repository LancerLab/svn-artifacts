module @f_18_resnet_64x256x56x56 {
  func.func @f_18_resnet_64x256x56x56(%input: memref<64x256x56x56xf32>) -> memref<64x256x56x56xf32> {
      ...
      scf.for %gi1 = %c0 to %input_d1 step %c1 {
        scf.for %gi2 = %c0 to %input_d2 step %c1 {
          scf.for %gi3 = %c0 to %input_d3 step %c1 {
            %xv      = memref.load %input[%gi0, %gi1, %gi2, %gi3] : memref<64x256x56x56xf32>
            ...
            memref.store %out_val, %out[%gi0, %gi1, %gi2, %gi3] : memref<64x256x56x56xf32>
          }
        }
      }
    }
