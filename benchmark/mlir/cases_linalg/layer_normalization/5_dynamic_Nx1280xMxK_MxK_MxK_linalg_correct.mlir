module {
  func.func @f_5_dynamic_Nx1280xMxK_MxK_MxK_correct(%input: tensor<?x1280x?x?xf32>, %gamma: tensor<?x?xf32>, %beta: tensor<?x?xf32>) -> tensor<?x1280x?x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<?x1280x?x?xf32>, tensor<?x?xf32>, tensor<?x?xf32>) outs(%init : tensor<?x1280x?x?xf32>) {
