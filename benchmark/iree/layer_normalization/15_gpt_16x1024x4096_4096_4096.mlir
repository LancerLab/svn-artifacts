module {
  func.func @f_15_gpt_16x1024x4096_4096_4096(%input: tensor<16x1024x4096xf32>, %gamma: tensor<4096xf32>, %beta: tensor<4096xf32>) -> tensor<16x1024x4096xf32> {
    ...
    %sumsq_t = tensor.empty() : tensor<16x1024xf32>
    %zero_f   = arith.constant 0.0 : f32
    %sum_init = linalg.fill ins(%zero_f : f32) outs(%sum_t : tensor<16x1024xf32>) -> tensor<16x1024xf32>
    %sumsq_init = linalg.fill ins(%zero_f : f32) outs(%sumsq_t : tensor<16x1024xf32>) -> tensor<16x1024xf32>
    ...
    } ins(%input : tensor<16x1024x4096xf32>) outs(%sum_init, %sumsq_init : tensor<16x1024xf32>, tensor<16x1024xf32>) {
    ...
    } -> (tensor<16x1024xf32>, tensor<16x1024xf32>)
    %eps = arith.constant 1.0e-05 : f32
    %mean_t = tensor.empty() : tensor<16x1024xf32>
    %istd_t = tensor.empty() : tensor<16x1024xf32>
    %mean_dummy = linalg.fill ins(%zero_f : f32) outs(%mean_t : tensor<16x1024xf32>) -> tensor<16x1024xf32>
    %istd_dummy = linalg.fill ins(%zero_f : f32) outs(%istd_t : tensor<16x1024xf32>) -> tensor<16x1024xf32>
    ...
    } ins(%sum_result, %sumsq_result : tensor<16x1024xf32>, tensor<16x1024xf32>) outs(%mean_dummy, %istd_dummy : tensor<16x1024xf32>, tensor<16x1024xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<16x1024x4096xf32>, tensor<16x1024xf32>, tensor<16x1024xf32>, tensor<4096xf32>, tensor<4096xf32>) outs(%out : tensor<16x1024x4096xf32>) {
