module {
  func.func @f_5_dynamic_Nx1280xHxW_1280_1280_Nx1280xHxW_mismatch(%input: tensor<?x1280x?x?xf32>, %gamma: tensor<1279xf32>, %beta: tensor<1280xf32>) -> tensor<?x1280x?x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<?x1280x?x?xf32>, tensor<1279xf32>, tensor<1280xf32>) outs(%init : tensor<?x1280x?x?xf32>) {
