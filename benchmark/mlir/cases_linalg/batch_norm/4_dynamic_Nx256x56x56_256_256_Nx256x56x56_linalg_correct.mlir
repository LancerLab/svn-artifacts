module {
  func.func @f_4_dynamic_Nx256x56x56_256_256_Nx256x56x56_correct(%input: tensor<?x256x56x56xf32>, %gamma: tensor<256xf32>, %beta: tensor<256xf32>) -> tensor<?x256x56x56xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<?x256x56x56xf32>, tensor<256xf32>, tensor<256xf32>) outs(%init : tensor<?x256x56x56xf32>) {
