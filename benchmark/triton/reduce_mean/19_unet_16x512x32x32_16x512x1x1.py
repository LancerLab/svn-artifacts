...
CASE_PATH = 'benchmark/choreo/reduce_mean/19_unet_16x512x32x32_16x512x1x1.co'
CASE_NAME = '19_unet_16x512x32x32_16x512x1x1'
CATEGORY = 'reduce_mean'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['16x512x32x32']
OUTPUT_TOKEN = '16x512x1x1'
BASE_NOTES = 'axes=2.3; keepdim'
...
HOST_EXTRAS = {'reduction': ((2, 3), True)}
