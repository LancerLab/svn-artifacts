module {
  func.func @f_6_dynamic_Nx1280xMxK_Nx1280x1x1_Nx1280xMxK_mismatch(%a: tensor<?x1280x?x?xf32>, %b: tensor<?x1279x1x1xf32>) -> tensor<?x1280x?x?xf32> {
    ...
    %r = linalg.add ins(%a, %b : tensor<?x1280x?x?xf32>, tensor<?x1279x1x1xf32>)
