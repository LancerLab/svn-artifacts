module {
  func.func @f_6_dynamic_128xCx112x112_112x112_112x112_mismatch(%input: tensor<128x?x112x112xf32>, %gamma: tensor<112x111xf32>, %beta: tensor<112x111xf32>) -> tensor<128x?x112x112xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<128x?x112x112xf32>, tensor<112x111xf32>, tensor<112x111xf32>) outs(%init : tensor<128x?x112x112xf32>) {
