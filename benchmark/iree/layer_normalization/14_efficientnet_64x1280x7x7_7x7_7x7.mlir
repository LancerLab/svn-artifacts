module {
  func.func @f_14_efficientnet_64x1280x7x7_7x7_7x7(%input: tensor<64x1280x7x7xf32>, %gamma: tensor<7x7xf32>, %beta: tensor<7x7xf32>) -> tensor<64x1280x7x7xf32> {
    ...
    %sum_t = tensor.empty() : tensor<64x1280xf32>
    %sumsq_t = tensor.empty() : tensor<64x1280xf32>
    %zero_f   = arith.constant 0.0 : f32
    %sum_init = linalg.fill ins(%zero_f : f32) outs(%sum_t : tensor<64x1280xf32>) -> tensor<64x1280xf32>
    %sumsq_init = linalg.fill ins(%zero_f : f32) outs(%sumsq_t : tensor<64x1280xf32>) -> tensor<64x1280xf32>
    ...
    } ins(%input : tensor<64x1280x7x7xf32>) outs(%sum_init, %sumsq_init : tensor<64x1280xf32>, tensor<64x1280xf32>) {
    ...
    } -> (tensor<64x1280xf32>, tensor<64x1280xf32>)
    %eps = arith.constant 1.0e-05 : f32
    %mean_t = tensor.empty() : tensor<64x1280xf32>
    %istd_t = tensor.empty() : tensor<64x1280xf32>
    %mean_dummy = linalg.fill ins(%zero_f : f32) outs(%mean_t : tensor<64x1280xf32>) -> tensor<64x1280xf32>
    %istd_dummy = linalg.fill ins(%zero_f : f32) outs(%istd_t : tensor<64x1280xf32>) -> tensor<64x1280xf32>
    ...
    } ins(%sum_result, %sumsq_result : tensor<64x1280xf32>, tensor<64x1280xf32>) outs(%mean_dummy, %istd_dummy : tensor<64x1280xf32>, tensor<64x1280xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<64x1280x7x7xf32>, tensor<64x1280xf32>, tensor<64x1280xf32>, tensor<7x7xf32>, tensor<7x7xf32>) outs(%out : tensor<64x1280x7x7xf32>) {
