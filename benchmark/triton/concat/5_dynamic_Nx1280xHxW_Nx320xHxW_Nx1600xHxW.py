...
CASE_PATH = 'benchmark/choreo/concat/5_dynamic_Nx1280xHxW_Nx320xHxW_Nx1600xHxW.co'
CASE_NAME = '5_dynamic_Nx1280xHxW_Nx320xHxW_Nx1600xHxW'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'H': 30, 'N': 8, 'W': 30}
INPUT_TOKENS = ['Nx1280xHxW', 'Nx320xHxW']
OUTPUT_TOKEN = 'Nx1600xHxW'
BASE_NOTES = 'axis=1'
