module @f_2_cnn_128x128x28x28 {
  flow.executable private @f_2_cnn_128x128x28x28_dispatch_0 {
    flow.executable.export public @f_2_cnn_128x128x28x28_dispatch_0_generic_12845056_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_2_cnn_128x128x28x28_dispatch_0_generic_12845056_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<12845056xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<12845056xf32>>) {
  ...
  func.func @f_2_cnn_128x128x28x28(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_2_cnn_128x128x28x28_dispatch_0::@f_2_cnn_128x128x28x28_dispatch_0_generic_12845056_f32(%1) : (tensor<12845056xf32>) -> tensor<12845056xf32>
