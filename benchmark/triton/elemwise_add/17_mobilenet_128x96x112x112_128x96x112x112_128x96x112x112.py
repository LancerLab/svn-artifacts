...
CASE_PATH = 'benchmark/choreo/elemwise_add/17_mobilenet_128x96x112x112_128x96x112x112_128x96x112x112.co'
CASE_NAME = '17_mobilenet_128x96x112x112_128x96x112x112_128x96x112x112'
CATEGORY = 'elemwise_add'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x96x112x112', '128x96x112x112']
