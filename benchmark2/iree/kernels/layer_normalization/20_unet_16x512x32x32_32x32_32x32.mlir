module {
  func.func @f_20_unet_16x512x32x32_32x32_32x32(%input: tensor<16x512x32x32xf32>, %gamma: tensor<32x32xf32>, %beta: tensor<32x32xf32>) -> tensor<16x512x32x32xf32> {
    ...
    } ins(%input : tensor<16x512x32x32xf32>) outs(%sum_init, %sumsq_init : tensor<16x512xf32>, tensor<16x512xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<16x512x32x32xf32>, tensor<16x512xf32>, tensor<16x512xf32>, tensor<32x32xf32>, tensor<32x32xf32>) outs(%out : tensor<16x512x32x32xf32>) {
