module {
  func.func @f_3_dynamic_16x256xHxW_256x256x3x3_16x256xHxW_S_P_D_mismatch(%img: tensor<16x256x?x?xf32>, %ker: tensor<256x255x3x3xf32>) -> tensor<16x256x?x?xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<16x256x?x?xf32>, tensor<256x255x3x3xf32>)
