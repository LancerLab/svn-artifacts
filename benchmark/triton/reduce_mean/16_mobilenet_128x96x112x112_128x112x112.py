...
CASE_PATH = 'benchmark/choreo/reduce_mean/16_mobilenet_128x96x112x112_128x112x112.co'
CASE_NAME = '16_mobilenet_128x96x112x112_128x112x112'
CATEGORY = 'reduce_mean'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x96x112x112']
OUTPUT_TOKEN = '128x112x112'
BASE_NOTES = 'axes=1'
