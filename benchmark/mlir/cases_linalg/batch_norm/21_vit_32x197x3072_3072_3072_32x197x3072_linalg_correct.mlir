module {
  func.func @f_21_vit_32x197x3072_3072_3072_32x197x3072_correct(%input: tensor<32x197x3072xf32>, %gamma: tensor<3072xf32>, %beta: tensor<3072xf32>) -> tensor<32x197x3072xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x197x3072xf32>, tensor<3072xf32>, tensor<3072xf32>) outs(%init : tensor<32x197x3072xf32>) {
