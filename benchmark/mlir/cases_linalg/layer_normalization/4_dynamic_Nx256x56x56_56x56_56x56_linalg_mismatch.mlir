module {
  func.func @f_4_dynamic_Nx256x56x56_56x56_56x56_mismatch(%input: tensor<?x256x56x56xf32>, %gamma: tensor<56x55xf32>, %beta: tensor<56x55xf32>) -> tensor<?x256x56x56xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<?x256x56x56xf32>, tensor<56x55xf32>, tensor<56x55xf32>) outs(%init : tensor<?x256x56x56xf32>) {
