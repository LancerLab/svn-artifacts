module {
  func.func @f_16_lstm_64x100x256_256_256_64x100x256_correct(%input: tensor<64x100x256xf32>, %gamma: tensor<256xf32>, %beta: tensor<256xf32>) -> tensor<64x100x256xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x100x256xf32>, tensor<256xf32>, tensor<256xf32>) outs(%init : tensor<64x100x256xf32>) {
