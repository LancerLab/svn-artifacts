module @f_13_dynamic_32x512xV {
  flow.executable private @f_13_dynamic_32x512xV_dispatch_0 {
    flow.executable.export public @f_13_dynamic_32x512xV_dispatch_0_generic_32x512xD_f32 workgroups(%arg0: index) -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg0
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_13_dynamic_32x512xV_dispatch_0_generic_32x512xD_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<32x512x?xf32>>, %arg1: index, %arg2: !flow.dispatch.tensor<writeonly:tensor<32x512x?xf32>>) {
  ...
  func.func @f_13_dynamic_32x512xV(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_13_dynamic_32x512xV_dispatch_0::@f_13_dynamic_32x512xV_dispatch_0_generic_32x512xD_f32[%0](%1, %0) : (tensor<32x512x?xf32>{%0}, index) -> tensor<32x512x?xf32>{%0}
