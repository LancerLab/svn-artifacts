...
CASE_PATH = 'benchmark/choreo/transpose/6_dynamic_128xCx112x112_128x112x112xC.co'
CASE_NAME = '6_dynamic_128xCx112x112_128x112x112xC'
CATEGORY = 'transpose'
SYMBOL_DEFAULTS = {'C': 16}
INPUT_TOKENS = ['128xCx112x112']
OUTPUT_TOKEN = '128x112x112xC'
BASE_NOTES = 'perm=0.2.3.1'
...
HOST_EXTRAS = {'permutation': (0, 2, 3, 1)}
