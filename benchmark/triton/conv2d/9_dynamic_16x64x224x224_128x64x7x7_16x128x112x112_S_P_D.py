...
CASE_PATH = 'benchmark/choreo/conv2d/9_dynamic_16x64x224x224_128x64x7x7_16x128x112x112_S_P_D.co'
CASE_NAME = '9_dynamic_16x64x224x224_128x64x7x7_16x128x112x112_S_P_D'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['16x64x224x224', '128x64x7x7']
OUTPUT_TOKEN = '16x128x112x112'
BASE_NOTES = 'stride=2; padding=3; dilation=1'
...
HOST_EXTRAS = {'stride': 2, 'padding': 3, 'dilation': 1}
