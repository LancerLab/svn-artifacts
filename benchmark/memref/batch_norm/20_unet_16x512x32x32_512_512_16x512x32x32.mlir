module @f_20_unet_16x512x32x32_512_512_16x512x32x32 {
  func.func @f_20_unet_16x512x32x32_512_512_16x512x32x32(%input: memref<16x512x32x32xf32>, %gamma: memref<512xf32>, %beta: memref<512xf32>) -> memref<16x512x32x32xf32> {
      ...
      scf.for %bn1 = %c0 to %input_d1 step %c1 {
        scf.for %bn2 = %c0 to %input_d2 step %c1 {
          scf.for %bn3 = %c0 to %input_d3 step %c1 {
            %xv  = memref.load %input[%bn0, %bn1, %bn2, %bn3] : memref<16x512x32x32xf32>
            ...
            memref.store %res, %out[%bn0, %bn1, %bn2, %bn3] : memref<16x512x32x32xf32>
          }
        }
      }
    }
