module {
  func.func @f_1_bert_32x512x768_512_512_32x512x768_correct(%input: tensor<32x512x768xf32>, %gamma: tensor<512xf32>, %beta: tensor<512xf32>) -> tensor<32x512x768xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x512x768xf32>, tensor<512xf32>, tensor<512xf32>) outs(%init : tensor<32x512x768xf32>) {
