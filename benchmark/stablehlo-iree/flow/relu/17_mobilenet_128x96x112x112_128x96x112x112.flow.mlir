module @f_17_mobilenet_128x96x112x112_128x96x112x112 {
  flow.executable private @f_17_mobilenet_128x96x112x112_128x96x112x112_dispatch_0 {
    flow.executable.export public @f_17_mobilenet_128x96x112x112_128x96x112x112_dispatch_0_generic_154140672_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_17_mobilenet_128x96x112x112_128x96x112x112_dispatch_0_generic_154140672_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<154140672xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<154140672xf32>>) {
  ...
  func.func @f_17_mobilenet_128x96x112x112_128x96x112x112(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_17_mobilenet_128x96x112x112_128x96x112x112_dispatch_0::@f_17_mobilenet_128x96x112x112_128x96x112x112_dispatch_0_generic_154140672_f32(%1) : (tensor<154140672xf32>) -> tensor<154140672xf32>
