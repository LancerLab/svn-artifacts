...
CASE_PATH = 'benchmark/choreo/matmul/18_resnet_128x2048_2048x1000_128x1000.co'
CASE_NAME = '18_resnet_128x2048_2048x1000_128x1000'
CATEGORY = 'matmul'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x2048', '2048x1000']
OUTPUT_TOKEN = '128x1000'
BASE_NOTES = ''
