...
CASE_PATH = 'benchmark/choreo/concat/8_dynamic_16x1024xD1_16x1024xD2_16x1024xD1pD2.co'
CASE_NAME = '8_dynamic_16x1024xD1_16x1024xD2_16x1024xD1pD2'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'D1': 64, 'D1pD2': 8, 'D2': 96}
INPUT_TOKENS = ['16x1024xD1', '16x1024xD2']
OUTPUT_TOKEN = '16x1024xD1pD2'
BASE_NOTES = 'axis=2'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--D1", type=int, default=64)
    parser.add_argument("--D1pD2", type=int, default=8)
