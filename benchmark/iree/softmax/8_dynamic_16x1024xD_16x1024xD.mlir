module {
  func.func @f_8_dynamic_16x1024xD_16x1024xD(%input: tensor<16x1024x?xf32>) -> tensor<16x1024x?xf32> {
    ...
    } ins(%input : tensor<16x1024x?xf32>) outs(%max_init : tensor<16x1024xf32>) {
    ^bb0(%in: f32, %cur: f32):
    ...
    %sum_result = linalg.generic {
      ...
      iterator_types = ["parallel", "parallel", "reduction"]
    } ins(%input, %max_result : tensor<16x1024x?xf32>, tensor<16x1024xf32>) outs(%sum_init : tensor<16x1024xf32>) {
    ...
    } ins(%input, %max_result, %sum_result : tensor<16x1024x?xf32>, tensor<16x1024xf32>, tensor<16x1024xf32>) outs(%out : tensor<16x1024x?xf32>) {
