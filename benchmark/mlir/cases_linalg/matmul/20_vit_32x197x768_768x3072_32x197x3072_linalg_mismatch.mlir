...
module {
  func.func @f_20_vit_32x197x768_768x3072_32x197x3072_mismatch(%a: tensor<32x197x768xf32>, %b: tensor<767x3072xf32>) -> tensor<32x197x3072xf32> {
    %cst = arith.constant 0.0 : f32
    %init = tensor.empty() : tensor<32x197x3072xf32>
    %fill = linalg.fill ins(%cst : f32) outs(%init : tensor<32x197x3072xf32>) -> tensor<32x197x3072xf32>
    %r = linalg.generic {
      indexing_maps = [#map_lhs, #map_rhs, #map_out],
      iterator_types = ["parallel", "parallel", "parallel", "reduction"]
    } ins(%a, %b : tensor<32x197x768xf32>, tensor<767x3072xf32>)
      outs(%fill : tensor<32x197x3072xf32>) {
