...
CASE_PATH = 'benchmark/choreo/max_pool2d/6_dynamic_Bx1280xHxW_Bx1280xHd2xWd2.co'
CASE_NAME = '6_dynamic_Bx1280xHxW_Bx1280xHd2xWd2'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'B': 8, 'H': 30, 'Hd2': 8, 'W': 30, 'Wd2': 8}
INPUT_TOKENS = ['Bx1280xHxW']
OUTPUT_TOKEN = 'Bx1280xHd2xWd2'
BASE_NOTES = 'kernel=2; stride=4; padding=0'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Hd2", type=int, default=8)
    parser.add_argument("--W", type=int, default=30)
    parser.add_argument("--Wd2", type=int, default=8)
...
HOST_EXTRAS = {'kernel': 2, 'stride': 4, 'padding': 0}
