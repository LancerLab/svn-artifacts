module {
  func.func @f_8_dynamic_16x512xHxW_16x512(%input: tensor<16x512x?x?xf32>) -> tensor<16x512xf32> {
    ...
    } ins(%input : tensor<16x512x?x?xf32>) outs(%sum_init : tensor<16x512xf32>) {
    ^bb0(%in: f32, %acc: f32):
    ...
    return %mean_result : tensor<16x512xf32>
  }
}
