...
CASE_PATH = 'benchmark/choreo/reshape/11_dynamic_16x512xSxS_16x512SS.co'
CASE_NAME = '11_dynamic_16x512xSxS_16x512SS'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'S': 20}
INPUT_TOKENS = ['16x512xSxS']
OUTPUT_TOKEN = '16x512SS'
BASE_NOTES = 'contract-invalid 11_dynamic_16x512xSxS_16x512SS: reshape must preserve element count'
