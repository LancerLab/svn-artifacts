module @f_19_transformer_32x512x2048 {
  flow.executable private @f_19_transformer_32x512x2048_dispatch_0 {
    flow.executable.export public @f_19_transformer_32x512x2048_dispatch_0_generic_33554432_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_19_transformer_32x512x2048_dispatch_0_generic_33554432_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<33554432xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<33554432xf32>>) {
  ...
  func.func @f_19_transformer_32x512x2048(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_19_transformer_32x512x2048_dispatch_0::@f_19_transformer_32x512x2048_dispatch_0_generic_33554432_f32(%1) : (tensor<33554432xf32>) -> tensor<33554432xf32>
