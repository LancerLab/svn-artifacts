...
CASE_PATH = 'benchmark/choreo/reshape/5_dynamic_Bx1280xHxW_Bx1280HW.co'
CASE_NAME = '5_dynamic_Bx1280xHxW_Bx1280HW'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'B': 8, 'H': 30, 'W': 30}
INPUT_TOKENS = ['Bx1280xHxW']
OUTPUT_TOKEN = 'Bx1280HW'
BASE_NOTES = 'contract-invalid 5_dynamic_Bx1280xHxW_Bx1280HW: reshape must preserve element count'
