...
CASE_PATH = 'benchmark/choreo/reshape/3_attention_BxSx768_BxSx12x64.co'
CASE_NAME = '3_attention_BxSx768_BxSx12x64'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'B': 8, 'S': 20}
INPUT_TOKENS = ['BxSx768']
OUTPUT_TOKEN = 'BxSx12x64'
BASE_NOTES = ''
