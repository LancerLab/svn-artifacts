module {
  func.func @f_5_dynamic_128xCx112x112_64xCx1x1_128x64x112x112_1_0_1_correct(%img: tensor<128x?x112x112xf32>, %ker: tensor<64x?x1x1xf32>) -> tensor<128x64x112x112xf32> {
