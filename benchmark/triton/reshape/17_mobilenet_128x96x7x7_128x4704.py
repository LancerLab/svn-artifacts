...
CASE_PATH = 'benchmark/choreo/reshape/17_mobilenet_128x96x7x7_128x4704.co'
CASE_NAME = '17_mobilenet_128x96x7x7_128x4704'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x96x7x7']
OUTPUT_TOKEN = '128x4704'
BASE_NOTES = ''
