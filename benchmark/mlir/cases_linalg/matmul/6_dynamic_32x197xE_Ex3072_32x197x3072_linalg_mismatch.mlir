...
module {
  func.func @f_6_dynamic_32x197xE_Ex3072_32x197x3072_mismatch(%a: tensor<32x197x?xf32>, %b: tensor<?x3072xf32>) -> tensor<32x197x3072xf32> {
    ...
    } ins(%a, %b : tensor<32x197x?xf32>, tensor<?x3072xf32>)
