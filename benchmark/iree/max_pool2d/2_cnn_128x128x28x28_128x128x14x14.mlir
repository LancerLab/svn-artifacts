module {
  func.func @f_2_cnn_128x128x28x28_128x128x14x14(%input: tensor<128x128x28x28xf32>) -> tensor<128x128x14x14xf32> {
    ...
    %filled = linalg.fill ins(%neg_inf : f32) outs(%out : tensor<128x128x14x14xf32>) -> tensor<128x128x14x14xf32>
    ...
    %result = linalg.pooling_nchw_max {dilations = dense<1> : vector<2xi64>, strides = dense<2> : vector<2xi64>}
      ins(%input, %kernel : tensor<128x128x28x28xf32>, tensor<2x2xf32>)
      outs(%filled : tensor<128x128x14x14xf32>) -> tensor<128x128x14x14xf32>
