module {
  func.func @f_17_static_8x256x64x64_21x256x1x1_8x21x64x64_1_0_1_mismatch(%img: tensor<8x256x64x64xf32>, %ker: tensor<21x255x1x1xf32>) -> tensor<8x21x64x64xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<8x256x64x64xf32>, tensor<21x255x1x1xf32>)
