module {
  func.func @f_1_bert_32x512x768_768_768(%input: tensor<32x512x768xf32>, %gamma: tensor<768xf32>, %beta: tensor<768xf32>) -> tensor<32x512x768xf32> {
    ...
    %sum_t = tensor.empty() : tensor<32x512xf32>
    %sumsq_t = tensor.empty() : tensor<32x512xf32>
    %zero_f   = arith.constant 0.0 : f32
    %sum_init = linalg.fill ins(%zero_f : f32) outs(%sum_t : tensor<32x512xf32>) -> tensor<32x512xf32>
    %sumsq_init = linalg.fill ins(%zero_f : f32) outs(%sumsq_t : tensor<32x512xf32>) -> tensor<32x512xf32>
    ...
    } ins(%input : tensor<32x512x768xf32>) outs(%sum_init, %sumsq_init : tensor<32x512xf32>, tensor<32x512xf32>) {
    ...
    %mean_t = tensor.empty() : tensor<32x512xf32>
    %istd_t = tensor.empty() : tensor<32x512xf32>
    %mean_dummy = linalg.fill ins(%zero_f : f32) outs(%mean_t : tensor<32x512xf32>) -> tensor<32x512xf32>
    %istd_dummy = linalg.fill ins(%zero_f : f32) outs(%istd_t : tensor<32x512xf32>) -> tensor<32x512xf32>
    ...
    } ins(%sum_result, %sumsq_result : tensor<32x512xf32>, tensor<32x512xf32>) outs(%mean_dummy, %istd_dummy : tensor<32x512xf32>, tensor<32x512xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<32x512x768xf32>, tensor<32x512xf32>, tensor<32x512xf32>, tensor<768xf32>, tensor<768xf32>) outs(%out : tensor<32x512x768xf32>) {
