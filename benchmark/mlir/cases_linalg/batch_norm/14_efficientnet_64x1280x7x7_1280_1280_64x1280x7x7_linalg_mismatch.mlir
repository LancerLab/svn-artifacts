module {
  func.func @f_14_efficientnet_64x1280x7x7_1280_1280_64x1280x7x7_mismatch(%input: tensor<64x1280x7x7xf32>, %gamma: tensor<1279xf32>, %beta: tensor<1280xf32>) -> tensor<64x1280x7x7xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x1280x7x7xf32>, tensor<1279xf32>, tensor<1280xf32>) outs(%init : tensor<64x1280x7x7xf32>) {
