module {
  func.func @f_8_dynamic_16x1024xD_16x1024xD_linalg(%input: tensor<16x1024x?xf32>) -> tensor<16x1024x?xf32> {
    ...
    } ins(%input : tensor<16x1024x?xf32>) outs(%init : tensor<16x1024x?xf32>) {
    ^bb0(%in: f32, %out: f32):
