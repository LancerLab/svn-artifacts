module {
  func.func @f_9_dynamic_64x128xHxW_HxW_HxW_correct(%input: tensor<64x128x?x?xf32>, %gamma: tensor<?x?xf32>, %beta: tensor<?x?xf32>) -> tensor<64x128x?x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x128x?x?xf32>, tensor<?x?xf32>, tensor<?x?xf32>) outs(%init : tensor<64x128x?x?xf32>) {
