...
CASE_PATH = 'benchmark/choreo/concat/2_cnn_128x128x28x28_128x256x28x28_128x384x28x28.co'
CASE_NAME = '2_cnn_128x128x28x28_128x256x28x28_128x384x28x28'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x128x28x28', '128x256x28x28']
OUTPUT_TOKEN = '128x384x28x28'
BASE_NOTES = 'axis=1'
