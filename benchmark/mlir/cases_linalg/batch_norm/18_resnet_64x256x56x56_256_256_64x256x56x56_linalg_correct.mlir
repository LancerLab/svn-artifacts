module {
  func.func @f_18_resnet_64x256x56x56_256_256_64x256x56x56_correct(%input: tensor<64x256x56x56xf32>, %gamma: tensor<256xf32>, %beta: tensor<256xf32>) -> tensor<64x256x56x56xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x256x56x56xf32>, tensor<256xf32>, tensor<256xf32>) outs(%init : tensor<64x256x56x56xf32>) {
