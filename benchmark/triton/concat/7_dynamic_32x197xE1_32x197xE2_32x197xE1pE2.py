...
CASE_PATH = 'benchmark/choreo/concat/7_dynamic_32x197xE1_32x197xE2_32x197xE1pE2.co'
CASE_NAME = '7_dynamic_32x197xE1_32x197xE2_32x197xE1pE2'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'E1': 64, 'E1pE2': 8, 'E2': 96}
INPUT_TOKENS = ['32x197xE1', '32x197xE2']
OUTPUT_TOKEN = '32x197xE1pE2'
BASE_NOTES = 'axis=2'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--E1", type=int, default=64)
    parser.add_argument("--E1pE2", type=int, default=8)
    parser.add_argument("--E2", type=int, default=96)
