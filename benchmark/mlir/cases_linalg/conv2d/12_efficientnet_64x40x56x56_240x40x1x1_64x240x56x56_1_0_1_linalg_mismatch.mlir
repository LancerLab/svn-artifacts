module {
  func.func @f_12_efficientnet_64x40x56x56_240x40x1x1_64x240x56x56_1_0_1_mismatch(%img: tensor<64x40x56x56xf32>, %ker: tensor<240x39x1x1xf32>) -> tensor<64x240x56x56xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<64x40x56x56xf32>, tensor<240x39x1x1xf32>)
