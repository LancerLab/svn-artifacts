...
CASE_PATH = 'benchmark/choreo/transpose/16_lstm_64x100x256_100x64x256.co'
CASE_NAME = '16_lstm_64x100x256_100x64x256'
CATEGORY = 'transpose'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['64x100x256']
OUTPUT_TOKEN = '100x64x256'
BASE_NOTES = 'perm=1.0.2'
