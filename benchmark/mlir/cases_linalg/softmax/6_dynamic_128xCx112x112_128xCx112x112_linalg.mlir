module {
  func.func @f_6_dynamic_128xCx112x112_128xCx112x112_linalg(%input: tensor<128x?x112x112xf32>) -> tensor<128x?x112x112xf32> {
    ...
    } ins(%input : tensor<128x?x112x112xf32>) outs(%init : tensor<128x?x112x112xf32>) {
    ^bb0(%in: f32, %out: f32):
