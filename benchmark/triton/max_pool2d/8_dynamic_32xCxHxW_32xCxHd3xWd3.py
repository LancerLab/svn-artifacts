...
CASE_PATH = 'benchmark/choreo/max_pool2d/8_dynamic_32xCxHxW_32xCxHd3xWd3.co'
CASE_NAME = '8_dynamic_32xCxHxW_32xCxHd3xWd3'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'C': 16, 'H': 30, 'Hd3': 8, 'W': 30, 'Wd3': 8}
INPUT_TOKENS = ['32xCxHxW']
OUTPUT_TOKEN = '32xCxHd3xWd3'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Hd3", type=int, default=8)
    parser.add_argument("--W", type=int, default=30)
    parser.add_argument("--Wd3", type=int, default=8)
