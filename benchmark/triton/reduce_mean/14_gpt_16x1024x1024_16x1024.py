...
CASE_PATH = 'benchmark/choreo/reduce_mean/14_gpt_16x1024x1024_16x1024.co'
CASE_NAME = '14_gpt_16x1024x1024_16x1024'
CATEGORY = 'reduce_mean'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['16x1024x1024']
OUTPUT_TOKEN = '16x1024'
BASE_NOTES = 'axes=2'
