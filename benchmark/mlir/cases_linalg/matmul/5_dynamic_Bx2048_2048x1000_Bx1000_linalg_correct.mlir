module {
  func.func @f_5_dynamic_Bx2048_2048x1000_Bx1000_correct(%a: tensor<?x2048xf32>, %b: tensor<2048x1000xf32>) -> tensor<?x1000xf32> {
    ...
    %r = linalg.matmul ins(%a, %b : tensor<?x2048xf32>, tensor<2048x1000xf32>)
