module {
  func.func @f_10_dynamic_16x512xHxW_16x512xHxW_16x512xHxW_correct(%a: tensor<16x512x?x?xf32>, %b: tensor<16x512x?x?xf32>) -> tensor<16x512x?x?xf32> {
    ...
    %r = linalg.add ins(%a, %b : tensor<16x512x?x?xf32>, tensor<16x512x?x?xf32>)
