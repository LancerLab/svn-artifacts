...
CASE_PATH = 'benchmark/choreo/reshape/9_dynamic_Bx256xHxW_Bx256HW.co'
CASE_NAME = '9_dynamic_Bx256xHxW_Bx256HW'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'B': 8, 'H': 30, 'W': 30}
INPUT_TOKENS = ['Bx256xHxW']
OUTPUT_TOKEN = 'Bx256HW'
BASE_NOTES = 'contract-invalid 9_dynamic_Bx256xHxW_Bx256HW: reshape must preserve element count'
