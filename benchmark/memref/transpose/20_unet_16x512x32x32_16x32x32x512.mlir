module @f_20_unet_16x512x32x32_16x32x32x512 {
  func.func @f_20_unet_16x512x32x32_16x32x32x512(%input: memref<16x512x32x32xf32>) -> memref<16x32x32x512xf32> {
    ...
    %out = memref.alloc() : memref<16x32x32x512xf32>
      ...
      scf.for %pi1 = %c0 to %input_d2 step %c1 {
        scf.for %pi2 = %c0 to %input_d3 step %c1 {
          scf.for %pi3 = %c0 to %input_d1 step %c1 {
            %tv    = memref.load %input[%pi0, %pi3, %pi1, %pi2] : memref<16x512x32x32xf32>
            memref.store %tv, %out[%pi0, %pi1, %pi2, %pi3] : memref<16x32x32x512xf32>
          }
        }
      }
    }
