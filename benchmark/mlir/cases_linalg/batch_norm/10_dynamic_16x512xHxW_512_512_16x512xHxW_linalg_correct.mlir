module {
  func.func @f_10_dynamic_16x512xHxW_512_512_16x512xHxW_correct(%input: tensor<16x512x?x?xf32>, %gamma: tensor<512xf32>, %beta: tensor<512xf32>) -> tensor<16x512x?x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<16x512x?x?xf32>, tensor<512xf32>, tensor<512xf32>) outs(%init : tensor<16x512x?x?xf32>) {
