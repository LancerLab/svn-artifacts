module {
  func.func @f_9_dynamic_64x128xHxW_128_128_64x128xHxW_mismatch(%input: tensor<64x128x?x?xf32>, %gamma: tensor<127xf32>, %beta: tensor<128xf32>) -> tensor<64x128x?x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x128x?x?xf32>, tensor<127xf32>, tensor<128xf32>) outs(%init : tensor<64x128x?x?xf32>) {
