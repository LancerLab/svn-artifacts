...
module {
  func.func @f_9_dynamic_16xSx512_512x256_16xSx256_mismatch(%a: tensor<16x?x512xf32>, %b: tensor<511x256xf32>) -> tensor<16x?x256xf32> {
    ...
    } ins(%a, %b : tensor<16x?x512xf32>, tensor<511x256xf32>)
