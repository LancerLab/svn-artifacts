module @f_18_resnet_64x256x56x56_64x256x56x56 {
  flow.executable private @f_18_resnet_64x256x56x56_64x256x56x56_dispatch_0 {
    flow.executable.export public @f_18_resnet_64x256x56x56_64x256x56x56_dispatch_0_generic_51380224_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_18_resnet_64x256x56x56_64x256x56x56_dispatch_0_generic_51380224_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<51380224xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<51380224xf32>>) {
  ...
  func.func @f_18_resnet_64x256x56x56_64x256x56x56(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_18_resnet_64x256x56x56_64x256x56x56_dispatch_0::@f_18_resnet_64x256x56x56_64x256x56x56_dispatch_0_generic_51380224_f32(%1) : (tensor<51380224xf32>) -> tensor<51380224xf32>
