module {
  func.func @f_10_dynamic_16x512xHxW_16x512xHxW_linalg(%input: tensor<16x512x?x?xf32>) -> tensor<16x512x?x?xf32> {
    ...
    } ins(%input : tensor<16x512x?x?xf32>) outs(%init : tensor<16x512x?x?xf32>) {
    ^bb0(%in: f32, %out: f32):
