module {
  func.func @f_14_efficientnet_64x1280x7x7_7x7_7x7_correct(%input: tensor<64x1280x7x7xf32>, %gamma: tensor<7x7xf32>, %beta: tensor<7x7xf32>) -> tensor<64x1280x7x7xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x1280x7x7xf32>, tensor<7x7xf32>, tensor<7x7xf32>) outs(%init : tensor<64x1280x7x7xf32>) {
