module {
  func.func @f_19_transformer_32x512x2048_2048_2048_mismatch(%input: tensor<32x512x2048xf32>, %gamma: tensor<2047xf32>, %beta: tensor<2047xf32>) -> tensor<32x512x2048xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x512x2048xf32>, tensor<2047xf32>, tensor<2047xf32>) outs(%init : tensor<32x512x2048xf32>) {
