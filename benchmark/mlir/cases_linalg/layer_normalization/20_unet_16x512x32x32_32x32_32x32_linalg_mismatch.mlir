module {
  func.func @f_20_unet_16x512x32x32_32x32_32x32_mismatch(%input: tensor<16x512x32x32xf32>, %gamma: tensor<32x31xf32>, %beta: tensor<32x31xf32>) -> tensor<16x512x32x32xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<16x512x32x32xf32>, tensor<32x31xf32>, tensor<32x31xf32>) outs(%init : tensor<16x512x32x32xf32>) {
