...
CASE_PATH = 'benchmark/choreo/conv2d/8_dynamic_64x256x28x28_Cx256x3x3_64xCx28x28_S_P_D.co'
CASE_NAME = '8_dynamic_64x256x28x28_Cx256x3x3_64xCx28x28_S_P_D'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {'C': 16}
INPUT_TOKENS = ['64x256x28x28', 'Cx256x3x3']
OUTPUT_TOKEN = '64xCx28x28'
