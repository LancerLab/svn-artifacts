module {
  func.func @f_20_vit_32x3x224x224_32x3x112x112(%input: tensor<32x3x224x224xf32>) -> tensor<32x3x112x112xf32> {
    ...
    %filled = linalg.fill ins(%neg_inf : f32) outs(%out : tensor<32x3x112x112xf32>) -> tensor<32x3x112x112xf32>
    ...
    %result = linalg.pooling_nchw_max {dilations = dense<1> : vector<2xi64>, strides = dense<2> : vector<2xi64>}
      ins(%input, %kernel : tensor<32x3x224x224xf32>, tensor<2x2xf32>)
      outs(%filled : tensor<32x3x112x112xf32>) -> tensor<32x3x112x112xf32>
