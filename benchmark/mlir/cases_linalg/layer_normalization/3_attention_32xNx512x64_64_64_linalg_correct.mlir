module {
  func.func @f_3_attention_32xNx512x64_64_64_correct(%input: tensor<32x?x512x64xf32>, %gamma: tensor<64xf32>, %beta: tensor<64xf32>) -> tensor<32x?x512x64xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x?x512x64xf32>, tensor<64xf32>, tensor<64xf32>) outs(%init : tensor<32x?x512x64xf32>) {
