module @f_14_efficientnet_64x1280x7x7_64x1280x7x7 {
  flow.executable private @f_14_efficientnet_64x1280x7x7_64x1280x7x7_dispatch_0 {
    flow.executable.export public @f_14_efficientnet_64x1280x7x7_64x1280x7x7_dispatch_0_generic_4014080_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_14_efficientnet_64x1280x7x7_64x1280x7x7_dispatch_0_generic_4014080_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<4014080xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<4014080xf32>>) {
  ...
  func.func @f_14_efficientnet_64x1280x7x7_64x1280x7x7(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_14_efficientnet_64x1280x7x7_64x1280x7x7_dispatch_0::@f_14_efficientnet_64x1280x7x7_64x1280x7x7_dispatch_0_generic_4014080_f32(%1) : (tensor<4014080xf32>) -> tensor<4014080xf32>
