module @f_18_transformer_32x512x2048_32x2048 {
  func.func @f_18_transformer_32x512x2048_32x2048(%input: tensor<32x512x2048xf32>) -> tensor<32x2048xf32> {
    ...
    %sum_red  = stablehlo.reduce(%input init: %zero) across dimensions = [1] : (tensor<32x512x2048xf32>, tensor<f32>) -> tensor<32x2048xf32>
      reducer(%lhs: tensor<f32>, %rhs: tensor<f32>)  {
        %s = stablehlo.add %lhs, %rhs : tensor<f32>
        stablehlo.return %s : tensor<f32>
      }
    %nsz      = stablehlo.constant dense<512.0> : tensor<32x2048xf32>
    %result   = stablehlo.divide %sum_red, %nsz : tensor<32x2048xf32>
