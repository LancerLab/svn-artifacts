module {
  func.func @f_9_dynamic_64x128xWxH_64x128xWxH_64x128xWxH_mismatch(%a: tensor<64x128x?x?xf32>, %b: tensor<63x128x?x?xf32>) -> tensor<64x128x?x?xf32> {
    ...
    %r = linalg.add ins(%a, %b : tensor<64x128x?x?xf32>, tensor<63x128x?x?xf32>)
