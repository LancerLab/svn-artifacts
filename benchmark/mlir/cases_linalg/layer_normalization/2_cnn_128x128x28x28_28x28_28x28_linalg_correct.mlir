module {
  func.func @f_2_cnn_128x128x28x28_28x28_28x28_correct(%input: tensor<128x128x28x28xf32>, %gamma: tensor<28x28xf32>, %beta: tensor<28x28xf32>) -> tensor<128x128x28x28xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<128x128x28x28xf32>, tensor<28x28xf32>, tensor<28x28xf32>) outs(%init : tensor<128x128x28x28xf32>) {
