module {
  func.func @f_18_resnet_64x256x56x56_56x56_56x56_mismatch(%input: tensor<64x256x56x56xf32>, %gamma: tensor<56x55xf32>, %beta: tensor<56x55xf32>) -> tensor<64x256x56x56xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x256x56x56xf32>, tensor<56x55xf32>, tensor<56x55xf32>) outs(%init : tensor<64x256x56x56xf32>) {
