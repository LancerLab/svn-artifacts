module {
  func.func @f_19_vit_32x3x224x224_768x3x16x16_32x768x14x14_16_0_1_correct(%img: tensor<32x3x224x224xf32>, %ker: tensor<768x3x16x16xf32>) -> tensor<32x768x14x14xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<32x3x224x224xf32>, tensor<768x3x16x16xf32>)
