...
module {
  func.func @f_1_bert_32x512x768_768x768_32x512x768_mismatch(%a: tensor<32x512x768xf32>, %b: tensor<767x768xf32>) -> tensor<32x512x768xf32> {
    ...
    } ins(%a, %b : tensor<32x512x768xf32>, tensor<767x768xf32>)
