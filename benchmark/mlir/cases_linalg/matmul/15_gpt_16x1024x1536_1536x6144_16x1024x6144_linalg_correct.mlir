...
module {
  func.func @f_15_gpt_16x1024x1536_1536x6144_16x1024x6144_correct(%a: tensor<16x1024x1536xf32>, %b: tensor<1536x6144xf32>) -> tensor<16x1024x6144xf32> {
    ...
    } ins(%a, %b : tensor<16x1024x1536xf32>, tensor<1536x6144xf32>)
