...
CASE_PATH = 'benchmark/choreo/batch_norm/5_dynamic_Nx1280xHxW_1280_1280_Nx1280xHxW.co'
CASE_NAME = '5_dynamic_Nx1280xHxW_1280_1280_Nx1280xHxW'
CATEGORY = 'batch_norm'
SYMBOL_DEFAULTS = {'H': 30, 'N': 8, 'W': 30}
INPUT_TOKENS = ['Nx1280xHxW', '1280', '1280']
OUTPUT_TOKEN = 'Nx1280xHxW'
BASE_NOTES = 'param-axis=1; normalize across batch axis'
...
HOST_EXTRAS = {'param_axis': 1}
INPUT_IS_SCALAR = (False, False, False)
