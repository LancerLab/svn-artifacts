...
CASE_PATH = 'benchmark/choreo/concat/16_lstm_64x100x256_64x100x256_64x100x512.co'
CASE_NAME = '16_lstm_64x100x256_64x100x256_64x100x512'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['64x100x256', '64x100x256']
OUTPUT_TOKEN = '64x100x512'
BASE_NOTES = 'axis=2'
