module {
  func.func @f_17_mobilenet_128x96x112x112_128x96x112x112_linalg(%input: tensor<128x96x112x112xf32>) -> tensor<128x96x112x112xf32> {
    ...
    } ins(%input : tensor<128x96x112x112xf32>) outs(%init : tensor<128x96x112x112xf32>) {
    ^bb0(%in: f32, %out: f32):
