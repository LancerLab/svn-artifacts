...
CASE_PATH = 'benchmark/choreo/embedding/8_dynamic_16xN_512x768_128xSx768.co'
CASE_NAME = '8_dynamic_16xN_512x768_128xSx768'
CATEGORY = 'embedding'
SYMBOL_DEFAULTS = {'N': 8, 'S': 20}
INPUT_TOKENS = ['16xN', '512x768']
OUTPUT_TOKEN = '128xSx768'
BASE_NOTES = 'contract-invalid 8_dynamic_16xN_512x768_128xSx768: embedding output leading dimensions must match ids'
