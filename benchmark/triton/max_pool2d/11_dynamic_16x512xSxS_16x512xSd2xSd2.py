...
CASE_PATH = 'benchmark/choreo/max_pool2d/11_dynamic_16x512xSxS_16x512xSd2xSd2.co'
CASE_NAME = '11_dynamic_16x512xSxS_16x512xSd2xSd2'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'S': 20, 'Sd2': 8}
INPUT_TOKENS = ['16x512xSxS']
OUTPUT_TOKEN = '16x512xSd2xSd2'
BASE_NOTES = 'kernel=2; stride=3; padding=2'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Sd2", type=int, default=8)
...
HOST_EXTRAS = {'kernel': 2, 'stride': 3, 'padding': 2}
