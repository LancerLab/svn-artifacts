module {
  func.func @f_1_bert_32x512_30522x768_32x512x768(%indices: tensor<32x512xi64>, %table: tensor<30522x768xf32>) -> tensor<32x512x768xf32> {
    ...
    %out_init = linalg.fill ins(%zero_emb : f32) outs(%out : tensor<32x512x768xf32>) -> tensor<32x512x768xf32>
    %result = linalg.generic {
      indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>],
      iterator_types = ["parallel", "parallel", "parallel"]
    } ins(%indices : tensor<32x512xi64>) outs(%out_init : tensor<32x512x768xf32>) {
