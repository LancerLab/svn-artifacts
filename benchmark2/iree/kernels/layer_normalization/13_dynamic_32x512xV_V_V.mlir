module {
  func.func @f_13_dynamic_32x512xV_V_V(%input: tensor<32x512x?xf32>, %gamma: tensor<?xf32>, %beta: tensor<?xf32>) -> tensor<32x512x?xf32> {
    ...
    %out = tensor.empty(%input_d2) : tensor<32x512x?xf32>
    ...
    %nsz_i64 = arith.index_cast %nsz_idx_1 : index to i64
    ...
    } ins(%input : tensor<32x512x?xf32>) outs(%sum_init, %sumsq_init : tensor<32x512xf32>, tensor<32x512xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<32x512x?xf32>, tensor<32x512xf32>, tensor<32x512xf32>, tensor<?xf32>, tensor<?xf32>) outs(%out : tensor<32x512x?xf32>) {
