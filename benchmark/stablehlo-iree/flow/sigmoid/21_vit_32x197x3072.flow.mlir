module @f_21_vit_32x197x3072 {
  flow.executable private @f_21_vit_32x197x3072_dispatch_0 {
    flow.executable.export public @f_21_vit_32x197x3072_dispatch_0_generic_19365888_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_21_vit_32x197x3072_dispatch_0_generic_19365888_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<19365888xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<19365888xf32>>) {
  ...
  func.func @f_21_vit_32x197x3072(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_21_vit_32x197x3072_dispatch_0::@f_21_vit_32x197x3072_dispatch_0_generic_19365888_f32(%1) : (tensor<19365888xf32>) -> tensor<19365888xf32>
