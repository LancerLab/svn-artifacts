module @f_9_dynamic_64x128xHxW {
  flow.executable private @f_9_dynamic_64x128xHxW_dispatch_0 {
    flow.executable.export public @f_9_dynamic_64x128xHxW_dispatch_0_generic_64x128xDxD_f32 workgroups(%arg0: index, %arg1: index) -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg0, %arg1
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_9_dynamic_64x128xHxW_dispatch_0_generic_64x128xDxD_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<64x128x?x?xf32>>, %arg1: index, %arg2: index, %arg3: !flow.dispatch.tensor<writeonly:tensor<64x128x?x?xf32>>) {
  ...
  func.func @f_9_dynamic_64x128xHxW(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %3 = flow.dispatch @f_9_dynamic_64x128xHxW_dispatch_0::@f_9_dynamic_64x128xHxW_dispatch_0_generic_64x128xDxD_f32[%0, %1](%2, %0, %1) : (tensor<64x128x?x?xf32>{%0, %1}, index, index) -> tensor<64x128x?x?xf32>{%0, %1}
