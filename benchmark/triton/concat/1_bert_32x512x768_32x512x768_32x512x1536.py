...
CASE_PATH = 'benchmark/choreo/concat/1_bert_32x512x768_32x512x768_32x512x1536.co'
CASE_NAME = '1_bert_32x512x768_32x512x768_32x512x1536'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['32x512x768', '32x512x768']
OUTPUT_TOKEN = '32x512x1536'
BASE_NOTES = 'axis=2'
