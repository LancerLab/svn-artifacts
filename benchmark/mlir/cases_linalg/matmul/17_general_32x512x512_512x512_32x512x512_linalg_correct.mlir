...
module {
  func.func @f_17_general_32x512x512_512x512_32x512x512_correct(%a: tensor<32x512x512xf32>, %b: tensor<512x512xf32>) -> tensor<32x512x512xf32> {
    ...
    } ins(%a, %b : tensor<32x512x512xf32>, tensor<512x512xf32>)
