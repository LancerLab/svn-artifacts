module {
  func.func @f_8_dynamic_16x1024xD_D_D(%input: tensor<16x1024x?xf32>, %gamma: tensor<?xf32>, %beta: tensor<?xf32>) -> tensor<16x1024x?xf32> {
    ...
    } ins(%input : tensor<16x1024x?xf32>) outs(%sum_init, %sumsq_init : tensor<16x1024xf32>, tensor<16x1024xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<16x1024x?xf32>, tensor<16x1024xf32>, tensor<16x1024xf32>, tensor<?xf32>, tensor<?xf32>) outs(%out : tensor<16x1024x?xf32>) {
