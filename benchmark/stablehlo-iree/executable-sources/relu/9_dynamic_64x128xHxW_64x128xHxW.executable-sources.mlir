module @f_9_dynamic_64x128xHxW_64x128xHxW attributes {hal.device.targets = [#hal.device.target<"cuda", {executable_targets = [#hal.executable.target<"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}>], legacy_sync}>]} {
  hal.executable private @f_9_dynamic_64x128xHxW_64x128xHxW_dispatch_0 {
    hal.executable.variant public @cuda_nvptx_fb, target = <"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}> {
      hal.executable.export public @f_9_dynamic_64x128xHxW_64x128xHxW_dispatch_0_generic_64x128xDxD_f32 ordinal(0) layout(#hal.pipeline.layout<push_constants = 2, sets = [<0, bindings = [<0, storage_buffer, ReadOnly>, <1, storage_buffer>]>]>) {
      ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index):
        %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg1, %arg2
        hal.return %x, %y, %z : index, index, index
      }
      builtin.module {
        func.func @f_9_dynamic_64x128xHxW_64x128xHxW_dispatch_0_generic_64x128xDxD_f32() {
  ...
  func.func @f_9_dynamic_64x128xHxW_64x128xHxW(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %8 = stream.cmd.execute with(%4 as %arg1: !stream.resource<external>{%3}, %5 as %arg2: !stream.resource<external>{%3}) {
      stream.cmd.dispatch @f_9_dynamic_64x128xHxW_64x128xHxW_dispatch_0::@cuda_nvptx_fb::@f_9_dynamic_64x128xHxW_64x128xHxW_dispatch_0_generic_64x128xDxD_f32[%0, %1](%6, %7 : i32, i32) {
