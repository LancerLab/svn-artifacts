...
CASE_PATH = 'benchmark/choreo/reshape/10_dynamic_64x128xHxW_64x128HW.co'
CASE_NAME = '10_dynamic_64x128xHxW_64x128HW'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'H': 30, 'W': 30}
INPUT_TOKENS = ['64x128xHxW']
OUTPUT_TOKEN = '64x128HW'
BASE_NOTES = 'contract-invalid 10_dynamic_64x128xHxW_64x128HW: reshape must preserve element count'
