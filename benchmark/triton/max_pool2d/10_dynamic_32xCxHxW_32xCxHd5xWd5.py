...
CASE_PATH = 'benchmark/choreo/max_pool2d/10_dynamic_32xCxHxW_32xCxHd5xWd5.co'
CASE_NAME = '10_dynamic_32xCxHxW_32xCxHd5xWd5'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'C': 16, 'H': 30, 'Hd5': 8, 'W': 30, 'Wd5': 8}
INPUT_TOKENS = ['32xCxHxW']
OUTPUT_TOKEN = '32xCxHd5xWd5'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Hd5", type=int, default=8)
    parser.add_argument("--W", type=int, default=30)
    parser.add_argument("--Wd5", type=int, default=8)
