...
CASE_PATH = 'benchmark/choreo/conv2d/14_mobilenet_128x32x112x112_32x32x3x3_128x32x112x112_S_P_D.co'
CASE_NAME = '14_mobilenet_128x32x112x112_32x32x3x3_128x32x112x112_S_P_D'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x32x112x112', '32x32x3x3']
OUTPUT_TOKEN = '128x32x112x112'
BASE_NOTES = 'stride=1; padding=1; dilation=1'
...
HOST_EXTRAS = {'stride': 1, 'padding': 1, 'dilation': 1}
