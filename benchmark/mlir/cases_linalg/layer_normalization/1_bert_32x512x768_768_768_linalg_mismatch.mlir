module {
  func.func @f_1_bert_32x512x768_768_768_mismatch(%input: tensor<32x512x768xf32>, %gamma: tensor<767xf32>, %beta: tensor<767xf32>) -> tensor<32x512x768xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x512x768xf32>, tensor<767xf32>, tensor<767xf32>) outs(%init : tensor<32x512x768xf32>) {
