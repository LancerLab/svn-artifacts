module @f_11_dynamic_32xSx768 attributes {hal.device.targets = [#hal.device.target<"cuda", {executable_targets = [#hal.executable.target<"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}>], legacy_sync}>]} {
  hal.executable private @f_11_dynamic_32xSx768_dispatch_0 {
    hal.executable.variant public @cuda_nvptx_fb, target = <"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}> {
      hal.executable.export public @f_11_dynamic_32xSx768_dispatch_0_generic_32xDx768_f32 ordinal(0) layout(#hal.pipeline.layout<push_constants = 1, sets = [<0, bindings = [<0, storage_buffer, ReadOnly>, <1, storage_buffer>]>]>) {
      ^bb0(%arg0: !hal.device, %arg1: index):
        %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg1
        hal.return %x, %y, %z : index, index, index
      }
      builtin.module {
        func.func @f_11_dynamic_32xSx768_dispatch_0_generic_32xDx768_f32() {
  ...
  func.func @f_11_dynamic_32xSx768(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %5 = stream.cmd.execute with(%2 as %arg1: !stream.resource<external>{%1}, %3 as %arg2: !stream.resource<external>{%1}) {
      stream.cmd.dispatch @f_11_dynamic_32xSx768_dispatch_0::@cuda_nvptx_fb::@f_11_dynamic_32xSx768_dispatch_0_generic_32xDx768_f32[%0](%4 : i32) {
