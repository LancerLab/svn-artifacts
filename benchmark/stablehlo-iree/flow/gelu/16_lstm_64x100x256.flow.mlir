module @f_16_lstm_64x100x256 {
  flow.executable private @f_16_lstm_64x100x256_dispatch_0 {
    flow.executable.export public @f_16_lstm_64x100x256_dispatch_0_generic_1638400_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_16_lstm_64x100x256_dispatch_0_generic_1638400_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<1638400xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<1638400xf32>>) {
  ...
  func.func @f_16_lstm_64x100x256(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_16_lstm_64x100x256_dispatch_0::@f_16_lstm_64x100x256_dispatch_0_generic_1638400_f32(%1) : (tensor<1638400xf32>) -> tensor<1638400xf32>
