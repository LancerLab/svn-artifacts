module {
  func.func @f_1_bert_32x512x768_32x512x768_32x512x768(%lhs: tensor<32x512x768xf32>, %rhs: tensor<32x512x768xf32>) -> tensor<32x512x768xf32> {
    ...
    %rhs_d0 = tensor.dim %rhs, %c0 : tensor<32x512x768xf32>
    %rhs_d1 = tensor.dim %rhs, %c1 : tensor<32x512x768xf32>
    %rhs_d2 = tensor.dim %rhs, %c2 : tensor<32x512x768xf32>
    ...
    } ins(%lhs, %rhs : tensor<32x512x768xf32>, tensor<32x512x768xf32>) outs(%out : tensor<32x512x768xf32>) {
