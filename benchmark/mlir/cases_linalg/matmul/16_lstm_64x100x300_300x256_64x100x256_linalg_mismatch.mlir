...
module {
  func.func @f_16_lstm_64x100x300_300x256_64x100x256_mismatch(%a: tensor<64x100x300xf32>, %b: tensor<299x256xf32>) -> tensor<64x100x256xf32> {
    %cst = arith.constant 0.0 : f32
    %init = tensor.empty() : tensor<64x100x256xf32>
    %fill = linalg.fill ins(%cst : f32) outs(%init : tensor<64x100x256xf32>) -> tensor<64x100x256xf32>
    %r = linalg.generic {
      indexing_maps = [#map_lhs, #map_rhs, #map_out],
      iterator_types = ["parallel", "parallel", "parallel", "reduction"]
    } ins(%a, %b : tensor<64x100x300xf32>, tensor<299x256xf32>)
      outs(%fill : tensor<64x100x256xf32>) {
