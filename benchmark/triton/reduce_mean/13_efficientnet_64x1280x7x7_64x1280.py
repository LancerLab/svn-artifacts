...
CASE_PATH = 'benchmark/choreo/reduce_mean/13_efficientnet_64x1280x7x7_64x1280.co'
CASE_NAME = '13_efficientnet_64x1280x7x7_64x1280'
CATEGORY = 'reduce_mean'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['64x1280x7x7']
OUTPUT_TOKEN = '64x1280'
BASE_NOTES = 'axes=2.3'
...
HOST_EXTRAS = {'reduction': ((2, 3), False)}
