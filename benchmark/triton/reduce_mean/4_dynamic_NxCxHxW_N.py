...
CASE_PATH = 'benchmark/choreo/reduce_mean/4_dynamic_NxCxHxW_N.co'
CASE_NAME = '4_dynamic_NxCxHxW_N'
CATEGORY = 'reduce_mean'
SYMBOL_DEFAULTS = {'C': 16, 'H': 30, 'N': 8, 'W': 30}
INPUT_TOKENS = ['NxCxHxW']
OUTPUT_TOKEN = 'N'
BASE_NOTES = 'axes=1.2.3'
...
HOST_EXTRAS = {'reduction': ((1, 2, 3), False)}
