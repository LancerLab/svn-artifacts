module @f_5_dynamic_Nx1280xHxW_Nx1280xHxW {
  flow.executable private @f_5_dynamic_Nx1280xHxW_Nx1280xHxW_dispatch_0 {
    flow.executable.export public @f_5_dynamic_Nx1280xHxW_Nx1280xHxW_dispatch_0_generic_Dx1280xDxD_f32 workgroups(%arg0: index, %arg1: index, %arg2: index) -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg0, %arg1, %arg2
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_5_dynamic_Nx1280xHxW_Nx1280xHxW_dispatch_0_generic_Dx1280xDxD_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<?x1280x?x?xf32>>, %arg1: index, %arg2: index, %arg3: index, %arg4: !flow.dispatch.tensor<writeonly:tensor<?x1280x?x?xf32>>) {
  ...
  func.func @f_5_dynamic_Nx1280xHxW_Nx1280xHxW(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %4 = flow.dispatch @f_5_dynamic_Nx1280xHxW_Nx1280xHxW_dispatch_0::@f_5_dynamic_Nx1280xHxW_Nx1280xHxW_dispatch_0_generic_Dx1280xDxD_f32[%0, %1, %2](%3, %0, %1, %2) : (tensor<?x1280x?x?xf32>{%0, %1, %2}, index, index, index) -> tensor<?x1280x?x?xf32>{%0, %1, %2}
