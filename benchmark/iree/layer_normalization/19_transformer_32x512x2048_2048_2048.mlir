module {
  func.func @f_19_transformer_32x512x2048_2048_2048(%input: tensor<32x512x2048xf32>, %gamma: tensor<2048xf32>, %beta: tensor<2048xf32>) -> tensor<32x512x2048xf32> {
    ...
    } ins(%input : tensor<32x512x2048xf32>) outs(%sum_init, %sumsq_init : tensor<32x512xf32>, tensor<32x512xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<32x512x2048xf32>, tensor<32x512xf32>, tensor<32x512xf32>, tensor<2048xf32>, tensor<2048xf32>) outs(%out : tensor<32x512x2048xf32>) {
