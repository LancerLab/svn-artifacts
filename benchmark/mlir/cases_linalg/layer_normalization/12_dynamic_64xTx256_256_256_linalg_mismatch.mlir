module {
  func.func @f_12_dynamic_64xTx256_256_256_mismatch(%input: tensor<64x?x256xf32>, %gamma: tensor<255xf32>, %beta: tensor<255xf32>) -> tensor<64x?x256xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<64x?x256xf32>, tensor<255xf32>, tensor<255xf32>) outs(%init : tensor<64x?x256xf32>) {
