module {
  func.func @f_14_efficientnet_64x1280x14x14_64x1280x7x7(%input: tensor<64x1280x14x14xf32>) -> tensor<64x1280x7x7xf32> {
    ...
    %filled = linalg.fill ins(%neg_inf : f32) outs(%out : tensor<64x1280x7x7xf32>) -> tensor<64x1280x7x7xf32>
    ...
    %result = linalg.pooling_nchw_max {dilations = dense<1> : vector<2xi64>, strides = dense<2> : vector<2xi64>}
      ins(%input, %kernel : tensor<64x1280x14x14xf32>, tensor<2x2xf32>)
      outs(%filled : tensor<64x1280x7x7xf32>) -> tensor<64x1280x7x7xf32>
