module {
  func.func @f_1_bert_32x512x768_32x512x768(%input: tensor<32x512x768xf32>) -> tensor<32x512x768xf32> {
    ...
    } ins(%input : tensor<32x512x768xf32>) outs(%max_init : tensor<32x512xf32>) {
    ^bb0(%in: f32, %cur: f32):
    ...
    %sum_result = linalg.generic {
      ...
      iterator_types = ["parallel", "parallel", "reduction"]
    } ins(%input, %max_result : tensor<32x512x768xf32>, tensor<32x512xf32>) outs(%sum_init : tensor<32x512xf32>) {
    ...
    } ins(%input, %max_result, %sum_result : tensor<32x512x768xf32>, tensor<32x512xf32>, tensor<32x512xf32>) outs(%out : tensor<32x512x768xf32>) {
