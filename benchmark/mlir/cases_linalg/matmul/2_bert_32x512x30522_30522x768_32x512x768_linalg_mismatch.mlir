...
module {
  func.func @f_2_bert_32x512x30522_30522x768_32x512x768_mismatch(%a: tensor<32x512x30522xf32>, %b: tensor<30521x768xf32>) -> tensor<32x512x768xf32> {
    ...
    } ins(%a, %b : tensor<32x512x30522xf32>, tensor<30521x768xf32>)
