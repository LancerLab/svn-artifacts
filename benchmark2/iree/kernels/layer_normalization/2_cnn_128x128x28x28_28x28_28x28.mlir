module {
  func.func @f_2_cnn_128x128x28x28_28x28_28x28(%input: tensor<128x128x28x28xf32>, %gamma: tensor<28x28xf32>, %beta: tensor<28x28xf32>) -> tensor<128x128x28x28xf32> {
    ...
    %sum_t = tensor.empty() : tensor<128x128xf32>
    %sumsq_t = tensor.empty() : tensor<128x128xf32>
    %zero_f   = arith.constant 0.0 : f32
    %sum_init = linalg.fill ins(%zero_f : f32) outs(%sum_t : tensor<128x128xf32>) -> tensor<128x128xf32>
    %sumsq_init = linalg.fill ins(%zero_f : f32) outs(%sumsq_t : tensor<128x128xf32>) -> tensor<128x128xf32>
    ...
    } ins(%input : tensor<128x128x28x28xf32>) outs(%sum_init, %sumsq_init : tensor<128x128xf32>, tensor<128x128xf32>) {
    ...
    %mean_t = tensor.empty() : tensor<128x128xf32>
    %istd_t = tensor.empty() : tensor<128x128xf32>
    %mean_dummy = linalg.fill ins(%zero_f : f32) outs(%mean_t : tensor<128x128xf32>) -> tensor<128x128xf32>
    %istd_dummy = linalg.fill ins(%zero_f : f32) outs(%istd_t : tensor<128x128xf32>) -> tensor<128x128xf32>
    ...
    } ins(%sum_result, %sumsq_result : tensor<128x128xf32>, tensor<128x128xf32>) outs(%mean_dummy, %istd_dummy : tensor<128x128xf32>, tensor<128x128xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<128x128x28x28xf32>, tensor<128x128xf32>, tensor<128x128xf32>, tensor<28x28xf32>, tensor<28x28xf32>) outs(%out : tensor<128x128x28x28xf32>) {
