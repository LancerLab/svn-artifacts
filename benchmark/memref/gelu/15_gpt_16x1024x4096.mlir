module @f_15_gpt_16x1024x4096 {
  func.func @f_15_gpt_16x1024x4096(%input: memref<16x1024x4096xf32>) -> memref<16x1024x4096xf32> {
    ...
    scf.for %gi0 = %c0 to %input_d0 step %c1 {
      scf.for %gi1 = %c0 to %input_d1 step %c1 {
        scf.for %gi2 = %c0 to %input_d2 step %c1 {
          %xv      = memref.load %input[%gi0, %gi1, %gi2] : memref<16x1024x4096xf32>
          ...
          memref.store %out_val, %out[%gi0, %gi1, %gi2] : memref<16x1024x4096xf32>
        }
      }
    }
