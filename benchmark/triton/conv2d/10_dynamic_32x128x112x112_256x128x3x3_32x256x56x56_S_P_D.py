...
CASE_PATH = 'benchmark/choreo/conv2d/10_dynamic_32x128x112x112_256x128x3x3_32x256x56x56_S_P_D.co'
CASE_NAME = '10_dynamic_32x128x112x112_256x128x3x3_32x256x56x56_S_P_D'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['32x128x112x112', '256x128x3x3']
OUTPUT_TOKEN = '32x256x56x56'
BASE_NOTES = 'stride=2; padding=1; dilation=1'
...
HOST_EXTRAS = {'stride': 2, 'padding': 1, 'dilation': 1}
