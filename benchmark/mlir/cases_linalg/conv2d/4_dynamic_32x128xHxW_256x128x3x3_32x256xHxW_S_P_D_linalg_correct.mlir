module {
  func.func @f_4_dynamic_32x128xHxW_256x128x3x3_32x256xHxW_S_P_D_correct(%img: tensor<32x128x?x?xf32>, %ker: tensor<256x128x3x3xf32>) -> tensor<32x256x?x?xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<32x128x?x?xf32>, tensor<256x128x3x3xf32>)
