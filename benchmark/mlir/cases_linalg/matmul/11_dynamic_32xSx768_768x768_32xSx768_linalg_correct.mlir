...
module {
  func.func @f_11_dynamic_32xSx768_768x768_32xSx768_correct(%a: tensor<32x?x768xf32>, %b: tensor<768x768xf32>) -> tensor<32x?x768xf32> {
    ...
    } ins(%a, %b : tensor<32x?x768xf32>, tensor<768x768xf32>)
