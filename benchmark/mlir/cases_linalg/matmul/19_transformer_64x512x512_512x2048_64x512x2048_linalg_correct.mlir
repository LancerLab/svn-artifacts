...
module {
  func.func @f_19_transformer_64x512x512_512x2048_64x512x2048_correct(%a: tensor<64x512x512xf32>, %b: tensor<512x2048xf32>) -> tensor<64x512x2048xf32> {
    ...
    } ins(%a, %b : tensor<64x512x512xf32>, tensor<512x2048xf32>)
