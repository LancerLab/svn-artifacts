module @f_1_bert_32x512x768_32x512x768_32x512x768 {
  func.func @f_1_bert_32x512x768_32x512x768_32x512x768(%in0: memref<32x512x768xf32>, %in1: memref<32x512x768xf32>) -> memref<32x512x768xf32> {
    ...
    scf.for %ae0 = %c0 to %in0_d0 step %c1 {
      scf.for %ae1 = %c0 to %in0_d1 step %c1 {
        scf.for %ae2 = %c0 to %in0_d2 step %c1 {
          ...
          %v1 = memref.load %in1[%ae0, %ae1, %ae2] : memref<32x512x768xf32>
