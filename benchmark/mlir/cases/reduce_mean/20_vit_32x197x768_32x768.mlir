module {
  func.func @f_20_vit_32x197x768_32x768(%input: tensor<32x197x768xf32>) -> tensor<32x768xf32> {
    ...
    %input_d0 = tensor.dim %input, %c0 : tensor<32x197x768xf32>
    %input_d1 = tensor.dim %input, %c1 : tensor<32x197x768xf32>
    %input_d2 = tensor.dim %input, %c2 : tensor<32x197x768xf32>
    ...
    %rv = tensor.extract %input[%rm_k0, %rm_r0, %rm_k1] : tensor<32x197x768xf32>
    ...
    %scale = arith.constant 0.005076142131979695 : f32
