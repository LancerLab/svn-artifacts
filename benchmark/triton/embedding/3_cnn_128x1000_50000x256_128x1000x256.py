...
CASE_PATH = 'benchmark/choreo/embedding/3_cnn_128x1000_50000x256_128x1000x256.co'
CASE_NAME = '3_cnn_128x1000_50000x256_128x1000x256'
CATEGORY = 'embedding'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x1000', '50000x256']
OUTPUT_TOKEN = '128x1000x256'
BASE_NOTES = ''
