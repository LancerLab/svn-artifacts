...
CASE_PATH = 'benchmark/choreo/conv2d/5_dynamic_128xCx112x112_64xCx1x1_128x64x112x112_1_0_1.co'
CASE_NAME = '5_dynamic_128xCx112x112_64xCx1x1_128x64x112x112_1_0_1'
CATEGORY = 'conv2d'
SYMBOL_DEFAULTS = {'C': 16}
INPUT_TOKENS = ['128xCx112x112', '64xCx1x1']
OUTPUT_TOKEN = '128x64x112x112'
BASE_NOTES = 'stride=1; padding=0; dilation=1'
...
HOST_EXTRAS = {'stride': 1, 'padding': 0, 'dilation': 1}
