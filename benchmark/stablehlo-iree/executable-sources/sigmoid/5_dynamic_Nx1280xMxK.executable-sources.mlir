module @f_5_dynamic_Nx1280xMxK attributes {hal.device.targets = [#hal.device.target<"cuda", {executable_targets = [#hal.executable.target<"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}>], legacy_sync}>]} {
  hal.executable private @f_5_dynamic_Nx1280xMxK_dispatch_0 {
    hal.executable.variant public @cuda_nvptx_fb, target = <"cuda", "cuda-nvptx-fb", {target_arch = "sm_60"}> {
      hal.executable.export public @f_5_dynamic_Nx1280xMxK_dispatch_0_generic_Dx1280xDxD_f32 ordinal(0) layout(#hal.pipeline.layout<push_constants = 3, sets = [<0, bindings = [<0, storage_buffer, ReadOnly>, <1, storage_buffer>]>]>) {
      ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
        %x, %y, %z = flow.dispatch.workgroup_count_from_slice %arg1, %arg2, %arg3
        hal.return %x, %y, %z : index, index, index
      }
      builtin.module {
        func.func @f_5_dynamic_Nx1280xMxK_dispatch_0_generic_Dx1280xDxD_f32() {
  ...
  func.func @f_5_dynamic_Nx1280xMxK(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %11 = stream.cmd.execute with(%6 as %arg1: !stream.resource<external>{%5}, %7 as %arg2: !stream.resource<external>{%5}) {
      stream.cmd.dispatch @f_5_dynamic_Nx1280xMxK_dispatch_0::@cuda_nvptx_fb::@f_5_dynamic_Nx1280xMxK_dispatch_0_generic_Dx1280xDxD_f32[%0, %1, %2](%8, %9, %10 : i32, i32, i32) {
