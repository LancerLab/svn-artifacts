module @f_20_unet_16x512x32x32 {
  flow.executable private @f_20_unet_16x512x32x32_dispatch_0 {
    flow.executable.export public @f_20_unet_16x512x32x32_dispatch_0_generic_8388608_f32 workgroups() -> (index, index, index) {
      %x, %y, %z = flow.dispatch.workgroup_count_from_slice 
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @f_20_unet_16x512x32x32_dispatch_0_generic_8388608_f32(%arg0: !flow.dispatch.tensor<readonly:tensor<8388608xf32>>, %arg1: !flow.dispatch.tensor<writeonly:tensor<8388608xf32>>) {
  ...
  func.func @f_20_unet_16x512x32x32(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    ...
    %2 = flow.dispatch @f_20_unet_16x512x32x32_dispatch_0::@f_20_unet_16x512x32x32_dispatch_0_generic_8388608_f32(%1) : (tensor<8388608xf32>) -> tensor<8388608xf32>
