...
CASE_PATH = 'benchmark/choreo/embedding/2_general_128x50_10000x128_128x50x128.co'
CASE_NAME = '2_general_128x50_10000x128_128x50x128'
CATEGORY = 'embedding'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['128x50', '10000x128']
OUTPUT_TOKEN = '128x50x128'
BASE_NOTES = ''
