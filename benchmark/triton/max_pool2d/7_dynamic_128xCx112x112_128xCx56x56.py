...
CASE_PATH = 'benchmark/choreo/max_pool2d/7_dynamic_128xCx112x112_128xCx56x56.co'
CASE_NAME = '7_dynamic_128xCx112x112_128xCx56x56'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'C': 16}
INPUT_TOKENS = ['128xCx112x112']
OUTPUT_TOKEN = '128xCx56x56'
BASE_NOTES = 'kernel=2; stride=2; padding=0'
...
HOST_EXTRAS = {'kernel': 2, 'stride': 2, 'padding': 0}
