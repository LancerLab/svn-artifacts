...
CASE_PATH = 'benchmark/choreo/max_pool2d/5_dynamic_Bx256x56x56_Bx256x28x28.co'
CASE_NAME = '5_dynamic_Bx256x56x56_Bx256x28x28'
CATEGORY = 'max_pool2d'
SYMBOL_DEFAULTS = {'B': 8}
INPUT_TOKENS = ['Bx256x56x56']
OUTPUT_TOKEN = 'Bx256x28x28'
