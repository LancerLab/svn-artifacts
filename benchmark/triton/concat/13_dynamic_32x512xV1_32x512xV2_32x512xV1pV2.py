...
CASE_PATH = 'benchmark/choreo/concat/13_dynamic_32x512xV1_32x512xV2_32x512xV1pV2.co'
CASE_NAME = '13_dynamic_32x512xV1_32x512xV2_32x512xV1pV2'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'V1': 128, 'V1pV2': 8, 'V2': 64}
INPUT_TOKENS = ['32x512xV1', '32x512xV2']
OUTPUT_TOKEN = '32x512xV1pV2'
BASE_NOTES = 'axis=2'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--V1", type=int, default=128)
    parser.add_argument("--V1pV2", type=int, default=8)
    parser.add_argument("--V2", type=int, default=64)
