...
CASE_PATH = 'benchmark/choreo/reshape/7_dynamic_32x197xE_32x197xEd64x64.co'
CASE_NAME = '7_dynamic_32x197xE_32x197xEd64x64'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'E': 128, 'Ed64': 8}
INPUT_TOKENS = ['32x197xE']
OUTPUT_TOKEN = '32x197xEd64x64'
BASE_NOTES = 'contract-invalid 7_dynamic_32x197xE_32x197xEd64x64: reshape must preserve element count'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Ed64", type=int, default=8)
