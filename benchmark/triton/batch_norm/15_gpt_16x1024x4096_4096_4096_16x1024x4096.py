...
CASE_PATH = 'benchmark/choreo/batch_norm/15_gpt_16x1024x4096_4096_4096_16x1024x4096.co'
CASE_NAME = '15_gpt_16x1024x4096_4096_4096_16x1024x4096'
CATEGORY = 'batch_norm'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['16x1024x4096', '4096', '4096']
OUTPUT_TOKEN = '16x1024x4096'
BASE_NOTES = 'param-axis=2; normalize across batch axis'
