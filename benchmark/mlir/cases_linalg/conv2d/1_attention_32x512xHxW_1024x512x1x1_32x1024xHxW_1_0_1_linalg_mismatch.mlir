module {
  func.func @f_1_attention_32x512xHxW_1024x512x1x1_32x1024xHxW_1_0_1_mismatch(%img: tensor<32x512x?x?xf32>, %ker: tensor<1024x511x1x1xf32>) -> tensor<32x1024x?x?xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<32x512x?x?xf32>, tensor<1024x511x1x1xf32>)
