...
CASE_PATH = 'benchmark/choreo/transpose/15_gpt_16x16x1024x64_16x1024x16x64.co'
CASE_NAME = '15_gpt_16x16x1024x64_16x1024x16x64'
CATEGORY = 'transpose'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['16x16x1024x64']
OUTPUT_TOKEN = '16x1024x16x64'
BASE_NOTES = 'perm=0.2.1.3'
...
HOST_EXTRAS = {'permutation': (0, 2, 1, 3)}
