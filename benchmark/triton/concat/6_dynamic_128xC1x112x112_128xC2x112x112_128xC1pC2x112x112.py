...
CASE_PATH = 'benchmark/choreo/concat/6_dynamic_128xC1x112x112_128xC2x112x112_128xC1pC2x112x112.co'
CASE_NAME = '6_dynamic_128xC1x112x112_128xC2x112x112_128xC1pC2x112x112'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'C1': 16, 'C1pC2': 8, 'C2': 8}
INPUT_TOKENS = ['128xC1x112x112', '128xC2x112x112']
OUTPUT_TOKEN = '128xC1pC2x112x112'
BASE_NOTES = 'axis=1'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--C1pC2", type=int, default=8)
