module {
  func.func @f_7_dynamic_8x256xHxW_512x256x1x1_8x512xHxW_1_0_1_correct(%img: tensor<8x256x?x?xf32>, %ker: tensor<512x256x1x1xf32>) -> tensor<8x512x?x?xf32> {
    ...
    %r = linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>}
         ins(%img, %ker : tensor<8x256x?x?xf32>, tensor<512x256x1x1xf32>)
