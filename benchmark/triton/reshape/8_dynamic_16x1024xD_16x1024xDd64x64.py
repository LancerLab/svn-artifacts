...
CASE_PATH = 'benchmark/choreo/reshape/8_dynamic_16x1024xD_16x1024xDd64x64.co'
CASE_NAME = '8_dynamic_16x1024xD_16x1024xDd64x64'
CATEGORY = 'reshape'
SYMBOL_DEFAULTS = {'D': 128, 'Dd64': 8}
INPUT_TOKENS = ['16x1024xD']
OUTPUT_TOKEN = '16x1024xDd64x64'
BASE_NOTES = 'contract-invalid 8_dynamic_16x1024xD_16x1024xDd64x64: reshape must preserve element count'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--Dd64", type=int, default=8)
