module {
  func.func @f_2_broadcast_128x256x28x28_256_128x256x28x28_mismatch(%a: tensor<128x256x28x28xf32>, %b: tensor<255xf32>) -> tensor<128x256x28x28xf32> {
    ...
    } ins(%a, %b : tensor<128x256x28x28xf32>, tensor<255xf32>) outs(%init : tensor<128x256x28x28xf32>) {
