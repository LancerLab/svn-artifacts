...
CASE_PATH = 'benchmark/choreo/concat/9_dynamic_64x128xHxW_64x128xHxW_64x256xHxW.co'
CASE_NAME = '9_dynamic_64x128xHxW_64x128xHxW_64x256xHxW'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'H': 30, 'W': 30}
INPUT_TOKENS = ['64x128xHxW', '64x128xHxW']
OUTPUT_TOKEN = '64x256xHxW'
BASE_NOTES = 'axis=1'
