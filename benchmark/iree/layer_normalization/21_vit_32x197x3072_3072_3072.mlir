module {
  func.func @f_21_vit_32x197x3072_3072_3072(%input: tensor<32x197x3072xf32>, %gamma: tensor<3072xf32>, %beta: tensor<3072xf32>) -> tensor<32x197x3072xf32> {
    ...
    } ins(%input : tensor<32x197x3072xf32>) outs(%sum_init, %sumsq_init : tensor<32x197xf32>, tensor<32x197xf32>) {
    ...
    } ins(%input, %mean_result, %istd_result, %gamma, %beta : tensor<32x197x3072xf32>, tensor<32x197xf32>, tensor<32x197xf32>, tensor<3072xf32>, tensor<3072xf32>) outs(%out : tensor<32x197x3072xf32>) {
