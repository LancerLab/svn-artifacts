module @f_13_efficientnet_64x1280x7x7_64x1280 {
  func.func @f_13_efficientnet_64x1280x7x7_64x1280(%input: memref<64x1280x7x7xf32>) -> memref<64x1280xf32> {
    ...
    %out = memref.alloc() : memref<64x1280xf32>
    ...
    scf.for %rm_b0 = %c0 to %input_d0 step %c1 {
      scf.for %rm_b1 = %c0 to %input_d1 step %c1 {
        ...
        %rm_sum = scf.for %rm_r0 = %c0 to %input_d2 step %c1 iter_args(%rm_s0 = %zero_f) -> (f32) {
          ...
          %rv   = memref.load %input[%rm_b0, %rm_b1, %rm_r0, %rm_r1] : memref<64x1280x7x7xf32>
        ...
        memref.store %rm_mean, %out[%rm_b0, %rm_b1] : memref<64x1280xf32>
      }
    }
    return %out : memref<64x1280xf32>
  }
}
