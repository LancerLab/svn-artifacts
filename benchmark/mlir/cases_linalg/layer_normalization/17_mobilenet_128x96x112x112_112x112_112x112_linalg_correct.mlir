module {
  func.func @f_17_mobilenet_128x96x112x112_112x112_112x112_correct(%input: tensor<128x96x112x112xf32>, %gamma: tensor<112x112xf32>, %beta: tensor<112x112xf32>) -> tensor<128x96x112x112xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<128x96x112x112xf32>, tensor<112x112xf32>, tensor<112x112xf32>) outs(%init : tensor<128x96x112x112xf32>) {
