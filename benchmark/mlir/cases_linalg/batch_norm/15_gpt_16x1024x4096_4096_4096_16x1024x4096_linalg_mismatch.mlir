module {
  func.func @f_15_gpt_16x1024x4096_4096_4096_16x1024x4096_mismatch(%input: tensor<16x1024x4096xf32>, %gamma: tensor<4095xf32>, %beta: tensor<4096xf32>) -> tensor<16x1024x4096xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<16x1024x4096xf32>, tensor<4095xf32>, tensor<4096xf32>) outs(%init : tensor<16x1024x4096xf32>) {
