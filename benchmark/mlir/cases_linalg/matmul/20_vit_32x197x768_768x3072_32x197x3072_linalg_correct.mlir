...
module {
  func.func @f_20_vit_32x197x768_768x3072_32x197x3072_correct(%a: tensor<32x197x768xf32>, %b: tensor<768x3072xf32>) -> tensor<32x197x3072xf32> {
    ...
    } ins(%a, %b : tensor<32x197x768xf32>, tensor<768x3072xf32>)
