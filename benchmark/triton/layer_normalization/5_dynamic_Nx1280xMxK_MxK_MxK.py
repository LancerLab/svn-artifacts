...
CASE_PATH = 'benchmark/choreo/layer_normalization/5_dynamic_Nx1280xMxK_MxK_MxK.co'
CASE_NAME = '5_dynamic_Nx1280xMxK_MxK_MxK'
CATEGORY = 'layer_normalization'
SYMBOL_DEFAULTS = {'K': 8, 'M': 8, 'N': 8}
INPUT_TOKENS = ['Nx1280xMxK', 'MxK', 'MxK']
OUTPUT_TOKEN = 'Nx1280xMxK'
BASE_NOTES = ''
