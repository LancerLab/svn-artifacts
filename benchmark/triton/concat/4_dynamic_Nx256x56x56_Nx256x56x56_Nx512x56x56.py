...
CASE_PATH = 'benchmark/choreo/concat/4_dynamic_Nx256x56x56_Nx256x56x56_Nx512x56x56.co'
CASE_NAME = '4_dynamic_Nx256x56x56_Nx256x56x56_Nx512x56x56'
CATEGORY = 'concat'
SYMBOL_DEFAULTS = {'N': 8}
INPUT_TOKENS = ['Nx256x56x56', 'Nx256x56x56']
OUTPUT_TOKEN = 'Nx512x56x56'
BASE_NOTES = 'axis=1'
