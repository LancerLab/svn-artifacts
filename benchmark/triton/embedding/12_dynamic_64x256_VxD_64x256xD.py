...
CASE_PATH = 'benchmark/choreo/embedding/12_dynamic_64x256_VxD_64x256xD.co'
CASE_NAME = '12_dynamic_64x256_VxD_64x256xD'
CATEGORY = 'embedding'
SYMBOL_DEFAULTS = {'D': 128, 'V': 256}
INPUT_TOKENS = ['64x256', 'VxD']
OUTPUT_TOKEN = '64x256xD'
BASE_NOTES = ''
