...
CASE_PATH = 'benchmark/choreo/relu/6_dynamic_128xCx112x112_128xCx112x112.co'
CASE_NAME = '6_dynamic_128xCx112x112_128xCx112x112'
CATEGORY = 'relu'
...
def describe_case(env: dict[str, int]) -> dict[str, object]:
    ...
    return {
        ...
        "notes": merge_notes(BASE_NOTES, "standalone unary kernel", f"op=relu", f"block_size={BLOCK_SIZE}"),
    }
