module {
  func.func @f_6_dynamic_128xCx112x112_C_C_128xCx112x112_correct(%input: tensor<128x?x112x112xf32>, %gamma: tensor<?xf32>, %beta: tensor<?xf32>) -> tensor<128x?x112x112xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<128x?x112x112xf32>, tensor<?xf32>, tensor<?xf32>) outs(%init : tensor<128x?x112x112xf32>) {
