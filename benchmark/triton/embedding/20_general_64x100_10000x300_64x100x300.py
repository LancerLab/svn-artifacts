...
CASE_PATH = 'benchmark/choreo/embedding/20_general_64x100_10000x300_64x100x300.co'
CASE_NAME = '20_general_64x100_10000x300_64x100x300'
CATEGORY = 'embedding'
SYMBOL_DEFAULTS = {}
INPUT_TOKENS = ['64x100', '10000x300']
OUTPUT_TOKEN = '64x100x300'
BASE_NOTES = ''
