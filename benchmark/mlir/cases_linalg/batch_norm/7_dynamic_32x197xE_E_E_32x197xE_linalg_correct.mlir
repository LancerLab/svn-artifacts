module {
  func.func @f_7_dynamic_32x197xE_E_E_32x197xE_correct(%input: tensor<32x197x?xf32>, %gamma: tensor<?xf32>, %beta: tensor<?xf32>) -> tensor<32x197x?xf32> {
    ...
    } ins(%input, %gamma, %beta : tensor<32x197x?xf32>, tensor<?xf32>, tensor<?xf32>) outs(%init : tensor<32x197x?xf32>) {
